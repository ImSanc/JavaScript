...
export const RevenueCard = ({
   ...
   return <div className= {`rounded-sm m-3  overflow-hidden  shadow-md card ${isMainCard ? 'bg-blue-700 text-white hover:bg-blue-600' : 'bg-white text-black' }`}>
        <div className = { `${isMainCard ? 'text-white' : ' text-gray-600' } px-2 py-1`}>
            {title}
        ...
        <div className="flex justify-between mt-3 px-2 py-1">
         ...
         { (isMainCard) ? <div className=" text-sm flex justify-between text-white bg-blue-900 py-2 px-6">
                    <div >
                        Next payout date:
                    </div> 
                    <div >
